...
export default class Ui{
    constructor(_scene){
        ...
        this.tacho = new Tacho(this.scene, this, this.scene.left + 56, 0);
        this.minimap = new Minimap(this.scene, this, this.scene.right - 56, 0);
        this.standings = new Standings(this.scene, this, 0, 0);
    }
...
class Tacho{
    constructor(_scene, _parent, _x, _y){
        ...
        this.alertTxt.setTint(this.parent.colors.alert);
        ...
        //create grav meter
        this.grav = {
            circle: this.scene.add.sprite(this.scene.left + 56, 64, "sprUiCircle").setTintFill(this.parent.colors.default),
            roll: this.scene.add.sprite(this.scene.left + 56, 64, "sprUiRoll").setTintFill(this.parent.colors.default),
            yaw: this.scene.add.sprite(this.scene.left + 56, 64, "sprUiSpawnerRoll").setTintFill(this.parent.colors.default),
            pitch: this.scene.add.sprite(this.scene.left + 56, 64, "sprUiSpawnerRoll").setTintFill(this.parent.colors.default),
            enemies: [
        ...
        this.target.graph.lineStyle(1, this.parent.colors.default);
